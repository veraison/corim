...
func TestValidateCCAPlatformImplementationID_AllCases(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.title, func(t *testing.T) {
			err := validateCCAPlatformImplementationID(&tc.env)
			if tc.shouldError {
				assert.Error(t, err)
...
func TestValidateCCAPlatformInstanceID_InEnvironment_AllCases(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.title, func(t *testing.T) {
			err := validateCCAPlatformInstanceID(&tc.env)
			if tc.shouldError {
				assert.Error(t, err)
				assert.Contains(t, err.Error(), tc.expectedMessage)
			} else {
...
func TestValidateCCADigests_AllCases(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.title, func(t *testing.T) {
			err := validateCCADigests(tc.digests)
			if tc.shouldError {
				assert.Error(t, err)
				assert.Contains(t, err.Error(), tc.expectedMessage)
			} else {
...
func TestValidateCCASignerID_InvalidCases(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.title, func(t *testing.T) {
			err := validateCCASignerID(tc.keys)
			assert.Error(t, err)
			assert.Contains(t, err.Error(), tc.expectedMessage)
		})
	}
...
func TestValidateCCAPlatformAttestVerifKey_AllCases(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.title, func(t *testing.T) {
			avk := tc.setupAVK()
			err := validateCCAPlatformAttestVerifKey(avk)
			if tc.shouldError {
				assert.Error(t, err)
...
func TestValidateCCAPlatformReferenceValue_AllCases(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.title, func(t *testing.T) {
			...
			err := validateCCAPlatformReferenceValue(refVal)
			if tc.shouldError {
				assert.Error(t, err)
				assert.Contains(t, err.Error(), tc.expectedMessage)
			} else {
