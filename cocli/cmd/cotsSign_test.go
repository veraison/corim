...
func Test_CotsSignCmd_unknown_argument(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_mandatory_args_missing_cots_file(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_mandatory_args_missing_meta_file(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_mandatory_args_missing_key_file(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_non_existent_unsigned_corim_file(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_bad_unsigned_corim(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_invalid_unsigned_corim(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_non_existent_meta_file(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_bad_meta_file(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_invalid_meta_file(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_non_existent_key_file(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_invalid_key_file(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_ok_with_default_output_file(t *testing.T) {
	cmd := NewCotsSignCmd()
...
func Test_CotsSignCmd_ok_with_custom_output_file(t *testing.T) {
	cmd := NewCotsSignCmd()
