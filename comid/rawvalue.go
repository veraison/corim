...
// NewRawValueWithMask returns a pointer to a new RawValue with a masked
...
// RawValue models a $raw-value-type-choice. These are vendor-defined values that
// are checked for consistency. Optionally, a mask specifies which bits within the
...
// registered using RegisterRawValueType to provide a new implementation of the
