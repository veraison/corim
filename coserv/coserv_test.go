...
func TestCoserv_ToCBOR_rv_class_simple(t *testing.T) {
	...
	// {0: "tag:example.com,2025:cc-platform#1.0.0", 1: {0: 2, 1: {0: [{0: 560(h'00112233'), 1: "Example Vendor", 2: "Example Model"}]}}}
	expected := comid.MustHexDecode(t, "a20078267461673a6578616d706c652e636f6d2c323032353a63632d706c6174666f726d23312e302e3001a2000201a10081a300d902304400112233016e4578616d706c652056656e646f72026d4578616d706c65204d6f64656c")
...
func TestCoserv_ToCBOR_exampleClassSelector(t *testing.T) {
	...
	// {0: "tag:example.com,2025:cc-platform#1.0.0", 1: {0: 2, 1: {0: [{0: 560(h'8999786556'), 1: "Example Vendor", 2: "Example Model"}, {0: 37(h'31FB5ABF023E4992AA4E95F9C1503BFA')}]}}}
	expected := comid.MustHexDecode(t, "a20078267461673a6578616d706c652e636f6d2c323032353a63632d706c6174666f726d23312e302e3001a2000201a10082a300d90230458999786556016e4578616d706c652056656e646f72026d4578616d706c65204d6f64656ca100d8255031fb5abf023e4992aa4e95f9c1503bfa")
...
func TestCoserv_ToCBOR_exampleInstanceSelector(t *testing.T) {
	...
	// {0: "tag:example.com,2025:cc-platform#1.0.0", 1: {0: 2, 1: {1: [550(h'02DEADBEEFDEAD'), 560(h'8999786556')]}}}
	expected := comid.MustHexDecode(t, "a20078267461673a6578616d706c652e636f6d2c323032353a63632d706c6174666f726d23312e302e3001a2000201a10182d902264702deadbeefdeadd90230458999786556")
...
func TestCoserv_ToCBOR_exampleGroupSelector(t *testing.T) {
	...
	// {0: "tag:example.com,2025:cc-platform#1.0.0", 1: {0: 2, 1: {2: [560(h'8999786556'), 37(h'31FB5ABF023E4992AA4E95F9C1503BFA')]}}}
	expected := comid.MustHexDecode(t, "a20078267461673a6578616d706c652e636f6d2c323032353a63632d706c6174666f726d23312e302e3001a2000201a10282d90230458999786556d8255031fb5abf023e4992aa4e95f9c1503bfa")
...
func TestCoserv_FromBase64Url_ok_class(t *testing.T) {
	tv := "ogB4JnRhZzpleGFtcGxlLmNvbSwyMDI1OmNjLXBsYXRmb3JtIzEuMC4wAaIAAgGhAIKjANkCMEWJmXhlVgFuRXhhbXBsZSBWZW5kb3ICbUV4YW1wbGUgTW9kZWyhANglUDH7Wr8CPkmSqk6V-cFQO_o"
...
func TestCoserv_FromBase64Url_ok_instance(t *testing.T) {
	tv := "ogB4JnRhZzpleGFtcGxlLmNvbSwyMDI1OmNjLXBsYXRmb3JtIzEuMC4wAaIAAgGhAYLZAiZHAt6tvu_erdkCMEWJmXhlVg"
...
func TestCoserv_FromBase64Url_ok_group(t *testing.T) {
	tv := "ogB4JnRhZzpleGFtcGxlLmNvbSwyMDI1OmNjLXBsYXRmb3JtIzEuMC4wAaIAAgGhAoLZAjBFiZl4ZVbYJVAx-1q_Aj5JkqpOlfnBUDv6"
...
func TestCoserv_ToBase64Url_ok_instance(t *testing.T) {
	...
	expected := "ogB4JnRhZzpleGFtcGxlLmNvbSwyMDI1OmNjLXBsYXRmb3JtIzEuMC4wAaIAAgGhAYLZAiZHAt6tvu_erdkCMEWJmXhlVg"
...
func TestCoserv_ToBase64Url_ok_class(t *testing.T) {
	...
	expected := "ogB4JnRhZzpleGFtcGxlLmNvbSwyMDI1OmNjLXBsYXRmb3JtIzEuMC4wAaIAAgGhAIKjANkCMEWJmXhlVgFuRXhhbXBsZSBWZW5kb3ICbUV4YW1wbGUgTW9kZWyhANglUDH7Wr8CPkmSqk6V-cFQO_o"
...
func TestCoserv_ToBase64Url_ok_group(t *testing.T) {
	...
	expected := "ogB4JnRhZzpleGFtcGxlLmNvbSwyMDI1OmNjLXBsYXRmb3JtIzEuMC4wAaIAAgGhAoLZAjBFiZl4ZVbYJVAx-1q_Aj5JkqpOlfnBUDv6"
...
func Test_ToEDN_ok(t *testing.T) {
	...
	expected := `{0: "tag:example.com,2025:cc-platform#1.0.0", 1: {0: 2, 1: {0: [{0: 560(h'8999786556'), 1: "Example Vendor", 2: "Example Model"}, {0: 37(h'31fb5abf023e4992aa4e95f9c1503bfa')}]}}}`

	assert.Equal(t, expected, actual)
}

func TestCoserv_FromCBOR_Results(t *testing.T) {
	// {0: "tag:example.com,2025:cc-platform#1.0.0", 1: {0: 2, 1: {0: [{0: 560(h'8999786556'), 1: "Example Vendor", 2: "Example Model"}, {0: 37(h'31fb5abf023e4992aa4e95f9c1503bfa')}]}}, 2: {0: [[{0: {0: 560(h'8999786556'), 1: "Example Vendor", 2: "Example Model"}}, [{1: {11: "Component A", 2: [[1, h'AA'], [2, h'BB']]}}, {1: {11: "Component B", 2: [[1, h'CC'], [2, h'DD']]}}]]]}}
	tv := comid.MustHexDecode(t, `

41bba101a20b6b436f6d706f6e656e7420420282820141cc820241dd`)
...
func TestCoserv_results_ToCBOR_ok(t *testing.T) {
	...
	// 	1: {0: 2, 1: {0: [{0: 560(h'8999786556')}]}},
	// 	2: {
	// 		10: 0("2030-12-13T18:30:02Z"),
	// 		0: [[{0: {0: 560(h'8999786556')}}, [{0: 37(h'31FB5ABF023E4992AA4E95F9C1503BFA'), 1: {0: {0: "1.2.3", 1: 16384}, 1: 553(2)}}]]]
	// 	}
	// }
	expected := comid.MustHexDecode(t, ``)
