...
// has finished. If an error occursed while iterating, the function will return
...
// after the iteration has finished. If an error occursed while iterating, the
...
// called after the iteration has finished. If an error occursed while
