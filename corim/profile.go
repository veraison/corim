...
// extension points are exercised and how. Currently supported types are URI
// and Tagged OID as per section 4.1.4 of CoRIM Specification.
type Profile struct {
	Value IProfileValue
}
...
// IsNil returns true if the *Profile is nil or if its inner value is nil.
